                            ...
                            <div class="row">
							  <div class="col-md-6">
                                <div class="form-group">
								 ...
								 <div class="controls">
									<input type="text" name="name" class="form-control" required data-validation-required-message="Adress is required"> </div>
							    </div>
                              </div>
                              <div class="col-md-6">
                                <div class="form-group">
								...
								<div class="controls">
									<input type="text" name="libelle" required data-validation-required-message="Phone number is required" class="form-control" required> </div>
						      	</div>
                              </div>
                            </div>
							<div class="row">
                           ...
                           <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                <div class="form-group">
								 ...
								 <div class="controls">
									<input type="text" name="teacher" class="form-control" required data-validation-required-message="Adress is required"> </div>
							    </div>
                              </div>
                         </div>
